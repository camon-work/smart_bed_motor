...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_B_Pin|LED_R_Pin|LED_G_Pin|DIP0_Pin
                          |DIP1_Pin|DIP2_Pin|DIP3_Pin|ADC_SEL3_Pin
                          |ADC_nEN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, TXEN_485_Pin|ADC_SEL0_Pin|ADC_SEL1_Pin|ADC_SEL2_Pin
                          |ADS_CLK_Pin|ADS_PDWN_Pin|ADS_GAIN0_Pin|ADS_GAIN1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GD_WAKE_GPIO_Port, GD_WAKE_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : LED_B_Pin LED_R_Pin LED_G_Pin DIP0_Pin
                           DIP1_Pin DIP2_Pin DIP3_Pin ADC_SEL3_Pin
                           ADC_nEN_Pin */
  GPIO_InitStruct.Pin = LED_B_Pin|LED_R_Pin|LED_G_Pin|DIP0_Pin
                          |DIP1_Pin|DIP2_Pin|DIP3_Pin|ADC_SEL3_Pin
                          |ADC_nEN_Pin;
  ...
  /*Configure GPIO pins : TXEN_485_Pin ADC_SEL0_Pin ADC_SEL1_Pin ADC_SEL2_Pin
                           ADS_CLK_Pin ADS_PDWN_Pin ADS_GAIN0_Pin ADS_GAIN1_Pin */
  GPIO_InitStruct.Pin = TXEN_485_Pin|ADC_SEL0_Pin|ADC_SEL1_Pin|ADC_SEL2_Pin
                          |ADS_CLK_Pin|ADS_PDWN_Pin|ADS_GAIN0_Pin|ADS_GAIN1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : ADS_DOUT_Pin */
  GPIO_InitStruct.Pin = ADS_DOUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(ADS_DOUT_GPIO_Port, &GPIO_InitStruct);
